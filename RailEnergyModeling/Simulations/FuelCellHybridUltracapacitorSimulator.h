...
namespace TrainSimulatorCLI {
    ...
    public ref class FuelCellHybridUltracapacitorSimulator : public TrainSimulator {
    ...
    public:
        FuelCellHybridUltracapacitorSimulator(mdlSimlinkName name, String^ modelDirectory)
