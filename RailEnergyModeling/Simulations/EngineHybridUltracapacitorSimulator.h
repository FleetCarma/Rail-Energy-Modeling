...
namespace TrainSimulatorCLI {
    ...
    public ref class EngineHybridUltracapacitorSimulator : public TrainSimulator {
    ...
    public:
        EngineHybridUltracapacitorSimulator(mdlSimlinkName name, String^ modelDirectory)
